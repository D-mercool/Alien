...
def start_game(ai_settings, screen, stats, ship, aliens, bullets):
    if stats.game_active == False:
        ...
        #Очистка список пришельцев и пуль.
        aliens.empty()
        bullets.empty()
...
def check_play_button(ai_settings, screen, stats, sb, play_button, ship,
    ...
    """Запускает новую игру при нажатии на кномпу Play"""
...
def get_number_rows(ai_settings, ship_height, alien_height):
    """Определение кол-во рядовб помещающихся на экран."""
...
def check_bullet_alien_collision(ai_settings, screen, stats, sb, ship,
                                 aliens, bullets):
    #Проверка попадания в пишельцев.
    #При попадании удалить пулю и пришельца.
